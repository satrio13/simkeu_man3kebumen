<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row">
        <div class="col-12">
            <?php 
            if($this->session->flashdata('msg-jenisbiaya'))
            {
                echo pesan_sukses($this->session->flashdata('msg-jenisbiaya'));
            }elseif($this->session->flashdata('msg-gagal-jenisbiaya'))
            {
                echo pesan_gagal($this->session->flashdata('msg-gagal-jenisbiaya'));
            }
            ?>
            <div class="card card-info">
                ...
                <?php echo form_open('backend/tambah-jenis-biaya'); ?>
                <div class="card-body">
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">JENIS BIAYA *</label>
                        <div class="col-sm-5">
                            <input type="text" name="jenisbiaya" value="<?= set_value('jenisbiaya'); ?>" class="form-control" id="inputEmail3" placeholder="JENIS BIAYA">
