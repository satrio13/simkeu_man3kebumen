        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="<?= base_url(); ?>backend/tambah-jurusan" class="btn bg-primary btn-flat text-white"><i class="fa fa-plus"></i> TAMBAH JURUSAN</a>
                            ...
                            foreach($data as $r):
                                echo'<tr>
                                        ...
                                        <td class="text-center">
                                            <a href="'.base_url("backend/edit-jurusan/$r->id_jurusan").'" class="btn btn-dark btn-xs btn-flat" title="EDIT DATA">EDIT</a>
                                            <a href="javascript:void(0)" class="btn btn-danger btn-xs btn-flat text-white" data-toggle="modal" data-target="#konfirmasi_hapus" data-href="'.base_url('backend/hapus-jurusan/'.$r->id_jurusan.'').'" title="HAPUS DATA">HAPUS</a>
                                        </td>
                                    </tr>';
                            endforeach;
                            ?>
