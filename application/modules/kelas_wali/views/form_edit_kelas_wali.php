                        ...
                        <div class="col-sm-5">
                            <select name="id_kelas" class="form-control required">
                                <?php foreach($kelas as $r): ?>
                                    <option value="<?= $r->id_kelas; ?>" <?php if($data->id_kelas == $r->id_kelas){ echo'selected'; } ?> ><?= $r->kelas; ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-sm-5">
                            <select name="id_guru" class="form-control required">
                                <?php foreach($guru as $r): ?>
                                    <option value="<?= $r->id_guru; ?>" <?php if($data->id_guru == $r->id_guru){ echo'selected'; } ?> ><?= $r->nama; ?></option>
                                <?php endforeach; ?>
                            </select>
