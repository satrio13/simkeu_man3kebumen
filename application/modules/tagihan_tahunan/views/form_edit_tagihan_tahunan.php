        ...
        <div class="col-12">
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-5">
                            <select name="id_tahunpelajaran" class="form-control required">
                                <?php foreach($tahunpelajaran as $r): ?>
                                    <option value="<?= $r->id_tahunpelajaran; ?>" <?php if($data->id_tahunpelajaran == $r->id_tahunpelajaran){ echo'selected'; } ?> ><?= $r->tahunpelajaran; ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-sm-5">
                            <select name="id_tagihan" class="form-control required" id="id_tagihan">
                                <?php foreach($tagihan as $r): ?>
                                    <option value="<?= $r->id_tagihan; ?>" <?php if($data->id_tagihan == $r->id_tagihan){ echo'selected'; } ?> ><?= $r->tagihan; ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="form-group row" 
                      <?php 
                      if( $this->uri->segment('2') == 'edit-tagihan-tahunan' AND id_jenistagihan($data->id_tagihan) == 3 )
                      {
                        ...
                        <div class="col-sm-5">
                            <select name="id_semester" class="form-control">
                              <?php foreach($semester as $r): ?>
                                <option value="<?= $r->id_semester; ?>" <?php if($data->id_semester == $r->id_semester){ echo'selected'; } ?> ><?= $r->semester; ?> / <?= $r->smt; ?></option>
                              <?php endforeach; ?>
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="number" name="perangkatan" min="0" value="<?= $data->perangkatan; ?>" class="form-control" placeholder="BIAYA PERANGKATAN">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="number" name="perangkatan_bsm" min="0" value="<?= $data->perangkatan_bsm; ?>" class="form-control" placeholder="BIAYA PERANGKATAN BSM">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="number" name="kelas10" min="0" value="<?= $data->kelas10; ?>" class="form-control" placeholder="BIAYA KELAS 10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="number" name="kelas10_bsm" min="0" value="<?= $data->kelas10_bsm; ?>" class="form-control" placeholder="BIAYA KELAS 10 BSM">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="number" name="kelas11" min="0" value="<?= $data->kelas11; ?>" class="form-control" placeholder="BIAYA KELAS 11">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="number" name="kelas11_bsm" min="0" value="<?= $data->kelas11_bsm; ?>" class="form-control" placeholder="BIAYA KELAS 11 BSM">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="number" name="kelas12" min="0" value="<?= $data->kelas12; ?>" class="form-control" placeholder="BIAYA KELAS 12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="number" name="kelas12_bsm" min="0" value="<?= $data->kelas12_bsm; ?>" class="form-control" placeholder="BIAYA KELAS 12 BSM">
