...
<table cellspacing="0" cellpadding="3" width="100%" border="1">
    ...
    endforeach; 
    echo'<tr>
            <td colspan="7" class="a" align="right"></td>
            <td class="a" align="right"><b>'.number_format($biaya_akhir, 0, ',', '.').'</b></td>
            <td class="a" align="right"><b>'.number_format($sudah_dibayar_akhir, 0, ',', '.').'</b></td>
            <td class="a" align="right"><b>'.number_format($kurang_akhir, 0, ',', '.').'</b></td>
        </tr>'; ?>
    </tbody>
</table>
<br>
