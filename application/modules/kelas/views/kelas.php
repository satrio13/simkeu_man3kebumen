        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="<?= base_url(); ?>backend/tambah-kelas" class="btn bg-primary btn-flat text-white"><i class="fa fa-plus"></i> TAMBAH KELAS</a>
                ...
                <div class="card-body">
                    <div class="table table-responsive">
                        <table class="table table-bordered table-striped table-sm" id="table-kelas">
